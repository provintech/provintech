  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium: "gradient-primary text-white shadow-elegant hover:shadow-glow transform hover:-translate-y-0.5",
        enterprise: "bg-sidebar-background text-sidebar-foreground hover:bg-sidebar-primary border border-sidebar-border",
        glass: "bg-white/10 backdrop-blur-sm border border-white/20 text-primary hover:bg-white/20",
      },
      size: {
